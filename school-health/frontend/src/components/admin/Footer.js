      ...
      <div className="footer-container">
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <ul>
              <li><a href="/nurse/help">Hướng dẫn sử dụng</a></li>
              <li><a href="/nurse/support">Hỗ trợ kỹ thuật</a></li>
              <li><a href="/nurse/privacy">Chính sách bảo mật</a></li>
              <li><a href="/nurse/terms">Điều khoản sử dụng</a></li>
            </ul>
          </div>
          <div className="footer-section">
